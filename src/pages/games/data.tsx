...
import worldExplorerImg from "../../assets/WorldExplorerImg.png";
...
import mysteryEggImg from "../../assets/mystery-egg-img.png";

export const gameCards = [
  {
    id: "mystery-egg",
    title: "Mystery Egg",
    description: "Savollarga javob bering, sehrli tuxumlarni sekin-asta yoring va ichidagi afsonaviy jonzotlarni ozod qiling.",
    mainIcon: FaEgg,
    icon: FaEgg,
    iconBg: "from-violet-500 to-lime-400",
    iconColor: "text-lime-100",
    shadowColor: "purple",
    available: true,
    path: "/games/mystery-egg",
    bgPattern: "bg-gradient-to-br from-indigo-950 via-violet-700 to-lime-500",
    image: mysteryEggImg,
    ...
    borderGlow: "hover:border-lime-400/50",
  },
  {
    id: "pizza-master",
    title: "Pizza Master",
  ...
  },
  {
    ...
    description:
      "VR issiqxona ichida urug' eking, o'simlikni parvarish qiling va biologiyani interaktiv tarzda o'rganing.",
    mainIcon: FaLeaf,
    icon: FaLeaf,
    ...
    available: true,
    path: "/games/plant-vr",
    bgPattern: "bg-gradient-to-br from-emerald-700 via-lime-700 to-amber-600",
    image: plantImg,
    players: "Jamoaviy o'yin",
    level: "VR Interaktiv",
    levelIcon: FaCompass,
    badge: "VR O'YIN",
    badgeIcon: FaLeaf,
  ...
  {
    id: "world-explorer",
    title: "Virtual Dunyo Sayohati",
    description: "3D globusda davlatlar haqida ma'lumotga ega bo'ling, geografiyani qiziqarli tarzda o'rganing.",
    mainIcon: FaGlobe,
    icon: FaGlobe,
    iconBg: "from-sky-500 to-emerald-500",
    iconColor: "text-sky-200",
    shadowColor: "sky",
    available: true,
    path: "/games/world-explorer",
    bgPattern: "bg-gradient-to-br from-sky-700 via-blue-700 to-emerald-700",
    image: worldExplorerImg,
    players: "Jamoaviy o'yin",
  ...
  {
    id: "virtual-zoo-vr",
    title: "Virtual Zoo Explorer VR",
    description:
      "VR zoopark ichida sayr qiling, hayvonlarga yaqinlashing va biologiyani immersive tarzda o'rganing.",
    mainIcon: GiJungle,
    icon: GiJungle,
    iconBg: "from-emerald-500 to-sky-400",
    iconColor: "text-emerald-100",
    shadowColor: "emerald",
    available: true,
    path: "/games/virtual-zoo-vr",
    bgPattern: "bg-gradient-to-br from-emerald-700 via-lime-700 to-sky-700",
    image: virtualZooVrImg,
    players: "Jamoaviy o'yin",
    level: "VR Immersive",
    levelIcon: FaCompass,
    badge: "NEW VR",
    ...
    gradient: "from-emerald-300 to-sky-300",
    borderGlow: "hover:border-emerald-300/50",
  },
  {
  id: "vr-solar-system",
  slug: "quyosh-tizimi-vr",
  title: "Koinot sayohati: Quyosh tizimi",
  subtitle: "VR va kompyuter uchun kinematik Quyosh tizimi",
  description: "Siqilgan, ammo ishonarli masshtabda 3D Quyosh tizimini o'rganing. Sayyorani tanlang, silliq yaqinlashing va qisqa premium faktlarni o'qing.",
  mainIcon: FaGlobe,
  icon: FaStar,
  ...
  route: "/games/quyosh-tizimi-vr",
  cover: solarSystemImg,
...
},
{
  ...
  },
  {
    ...
    description:
      "Ikki jamoa bir vaqtning o'zida matematik savollarga javob beradi. Har to'g'ri javob arqonni o'z tomonga tortadi va g'alaba uchun kurash boshlanadi.",
    mainIcon: GiRopeCoil,
    icon: FaUsers,
    iconBg: "from-blue-500 to-orange-500",
    iconColor: "text-blue-100",
    shadowColor: "blue",
    available: true,
    path: "/games/tug-of-war",
    bgPattern: "bg-gradient-to-br from-blue-600 via-slate-700 to-orange-500",
    image: tugOfWarImg,
    players: "2 jamoa",
    level: "Oson - Qiyin",
    levelIcon: FaStar,
  ...
  },
  {
    ...
    description:
      "1 o'yinchi rekord uchun yoki 2 o'yinchi navbat bilan zanjirni eslab qolib, tezda takrorlaydi.",
    mainIcon: GiBrain,
    icon: FaBrain,
    iconBg: "from-cyan-500 to-blue-500",
    iconColor: "text-cyan-300",
  ...
  },
  {
    ...
    description:
      "2 jamoa o'ynaydi. Har raundda 3 ta claim beriladi. 2 tasi TRUE, 1 tasi FAKE. FAKE'ni topgan jamoa +1 ball oladi.",
  ...
  },
  {
    ...
    description:
      "2 o'yinchi jo'jalar poygasida bellashadi: misollarni tez yeching va birinchi bo'lib marraga yetib boring.",
    mainIcon: GiChicken,
    icon: FaBrain,
